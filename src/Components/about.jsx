...
//             <img src="../assets/modernPortfolio.png" alt="logo" className="w-10 h-10" />
...
//               <a href="../assets/21AG30029.pdf" download>
...
//             <img className="object-cover object-center rounded" alt="hero" src="../assets/ramMohan.png" />
//           </div>
//         </div>
//       </section>
//     </div>
        ...
        <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16  flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center mt-[-50px]">
            ...
            <div className="flex justify-center">
              ...
              <button className="ml-4 inline-flex text-gray-700 bg-gray-100 border-0 py-2 px-6 focus:outline-none hover:bg-gray-200 rounded text-lg">
                <a href={'#'} className="mr-5  cursor-pointer hover:text-indigo-600">Projects</a>
              </button>
            </div>
          </div>
          <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
